...
def random_component_by_score(component_type, component_map):
    # Make sure componenet_type is 'llm', 'retriever', or 'memory'
    ...
    # From reid, get the has containing  the number of times each component has been voted on 
    ...
    # Add the average score to a dictionary
    avg_scores = {}
    for name in names:
